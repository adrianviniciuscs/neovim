...
local on_attach = function(client, bufnr)
  ...
  wk.add({
    ...
    { "<leader>lf", function() require("conform").format({ lsp_fallback = true }) end, desc = "Format Document", buffer = bufnr },
    ...
    { "<leader>wl", function() print(vim.inspect(vim.lsp.buf.list_workspace_folders())) end, desc = "List Folders", buffer = bufnr },
  })
